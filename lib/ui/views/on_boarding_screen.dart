...
child: Column(
  ...
  children: [const Text("Discover job",style: TextStyle(fontWeight:FontWeight.bold ,fontSize: 25),),
  
  
  SizedBox(height: deviceHeight*0.004,),
  const Text("Opportunites Effotlessly!",style: TextStyle(fontWeight:FontWeight.bold ,fontSize: 20),),
    SizedBox(height: deviceHeight*0.01,),

  
    const Text("welcome to our app in which you can sing as en employee or as a society",textAlign: TextAlign.center,),
  Expanded(
    child: Row(
      children: [
        Expanded(
      ...
      child: const Center(child: Text("Get Started",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold ),),),),),
    ),
    ...
    Expanded(
      ...
      child: const Align(
        ...
        child: Text("I am an Employee",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold ),)),),),
    ),],),
  ),
